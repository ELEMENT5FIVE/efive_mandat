 ...
 */
class Efive_MandatPaymentModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function initContent()
    {
        ...
        $this->context->smarty->assign([
            ...
            'confirm_url' => $this->context->link->getModuleLink('efive_mandat', 'validation', [], true),
            'image_url' => $this->module->getPathUri() . 'efive_mandat.jpg',
